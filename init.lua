...
vim.g.formatoptions = 'jql'

-- Set Spell language
vim.o.spelllang = 'pt_pt,en_us'
-- vim.o.spell = true
...
-- Set focus mode for writing
vim.keymap.set('n', 'tz', ':MUcompleteAutoOn<CR> :TZAtaraxis<CR> :set spell<CR>')
vim.keymap.set('n', 'TZ!', ':MUcompleteAutoOff<CR> :TZAtaraxis<CR> :set spell!<CR>')
